...
#define AK09916_ADDRESS (uint8_t)0x0C
...
/* Others */
#define AK09916_WHO_AM_I_1 (uint16_t)0x4809
#define AK09916_WHO_AM_I_2 (uint16_t)0x0948
#define ICM20948_WHO_AM_I_CONTENT (uint8_t)0xEA
#define ICM20948_ROOM_TEMP_OFFSET (float)0.0
#define ICM20948_T_SENSITIVITY (float)333.87
#define AK09916_MAG_LSB (float)0.1495
#define ICM20948_I2C_MST_RST (uint8_t)0x02

    std::shared_ptr<Cpp_Bus_Driver::Bus_Iic_Guide> _bus;
    ...
    ICM20948_WE(std::shared_ptr<Cpp_Bus_Driver::Bus_Iic_Guide> bus, int16_t address)
    ...
    bool begin(int32_t freq_hz = 100000);
    void autoOffsets();
